...
namespace QuanLyXeMay
{
    public partial class MenuApp : Form
    {
        ...
        {
            QLNhanVien menuForm = new QLNhanVien(_vaitro);
            menuForm.Show();
            this.Hide();
        }
        private void hoadon_Click(object sender, EventArgs e)
        {
            QLHoaDon menuForm = new QLHoaDon(_vaitro);
            menuForm.Show();
            this.Hide();
        }
        private void xemay_Click(object xemay_Clicksender, EventArgs e)
        {
            QLXeMay menuForm = new QLXeMay(_vaitro);
            menuForm.Show();
            this.Hide();
        }
        ...
        {
            QLKhachHang menuForm = new QLKhachHang(_vaitro);
            menuForm.Show();
            this.Hide();
        }
