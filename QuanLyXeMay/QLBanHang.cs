...
namespace QuanLyXeMay
{
    public partial class QLBanHang : Form
    {
        ...
        string _vaitro;
        public QLBanHang(int maSanPham, string vaitro)
        {
            _vaitro = vaitro;
        ...
        private void btnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            QLThanhToan menuForm = new QLThanhToan(listSanPhamItem, _vaitro);
            menuForm.Show();
            this.Hide();
        }
        ...
        {
            QLBanHang menuForm = new QLBanHang(idSelected, _vaitro);
            menuForm.Show();
            this.Hide();
        }
