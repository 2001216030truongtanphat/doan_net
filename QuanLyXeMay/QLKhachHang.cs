...
namespace QuanLyXeMay
{
    public partial class QLKhachHang : Form
    {
        ...
        string _vaitro = "nguoidung";
        public QLKhachHang(string vaiTro)
        {
        ...
        {
            MenuApp menuForm = new MenuApp(_vaitro);
            menuForm.Show();
            this.Hide();
        }
        ...
        {
            DialogResult result = MessageBox.Show("Bạn có muốn xóa người dùng không?", "Xác nhận xóa", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
